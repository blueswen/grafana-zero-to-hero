...
export default {
  ...
  methods: {
    ...
    triggerBackendError() {
      faro.api.pushEvent("ui.click.button.trigger_backend_error", {
        target: "#btn-trigger-backend-error",
      });
    ...
    triggerFrontendError() {
      faro.api.pushEvent("ui.click.button.trigger_frontend_error", {
        target: "#btn-trigger-frontend-error",
      });
      throw new Error('Triggered Error');
    },
    consoleLog() {
      faro.api.pushEvent("ui.click.button.console_log", {
        target: "#btn-console-log",
      });
